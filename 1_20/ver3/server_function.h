...
int accept_client(int serv_sock, struct sockaddr_in *clnt_addr, ServerState *state);
int fork_and_exec_worker(int serv_sock, int clnt_sock, int session_id, struct sockaddr_in *clnt_addr, ServerState *state);
void handle_child_died(ServerState *state);
void shutdown_workers(ServerState *state);
void final_cleanup(ServerState *state);
void child_process_main(int client_sock, int session_id, struct sockaddr_in client_addr, ServerState *state);
...
void setup_child_signal_handlers(ServerState *state);
